...
class MeCab:auth<titsuki>:ver<0.0.12> { }
class MeCab::Path:auth<titsuki>:ver<0.0.12> is repr('CStruct') { ... }
class MeCab::Node:auth<titsuki>:ver<0.0.12> is repr('CStruct') is export {
    enum Stat is export (
        :MECAB_NOR_NODE(0),
        :MECAB_UNK_NODE(1),
        :MECAB_BOS_NODE(2),
